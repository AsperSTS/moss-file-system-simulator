...
// Formatea y muestra la información del archivo, incluyendo UID, GID y los 9 bits de modo      
    t = Integer.toString(stat.getIno());
        s.append(df.format(Integer.parseInt(t)));
        s.append(' ');
  ...
  // Formatea los 9 bits de modo como un número octal de 3 dígitos
    t = Integer.toOctalString(stat.getMode() & 0777);
        s.append(String.format("%3s", t).replace(' ', '0'));
        s.append(' ');   
